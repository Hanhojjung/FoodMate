...
import com.example.foodmate2.controller.controller.SharedPreferencesUtil.checkLoggedIn
import com.example.foodmate2.controller.controller.SharedPreferencesUtil.setLoggedIn
import com.example.foodmate2.databinding.ActivityMainBinding
    ...
    private fun showPopupMenu(view: View) {
        ...
        popupMenu.setOnMenuItemClickListener(PopupMenu.OnMenuItemClickListener { item ->
            ...
            if (itemId == R.id.writing) {
                ...
                val intent = Intent(this@MainActivity, BoardInsertActivity::class.java)
                startActivity(intent)
